...
<section class="content-block centered ">
    ...
    <a class="action-button" href="next.php">next</a>
    <a class="action-button" href="close.php">close</a>
    <a class="action-button" href="cookie.php">cookie</a>
</section>
<h2 class="main-title" title="Variables">Session</h2>
<section class="content-block centered ">
    <h3 class="content-block__title">Session Count</h3>
    <p class="content-block__text">Session #<?php echo $_SESSION['count']; ?></p>
</section>
