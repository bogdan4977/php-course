...
/**
** 1) Создать таблицу отзывов, записать отзыв, достать отзыв заменить матюки (без регулярок)
 */
?>
...
<section class="content-block centered">
    <p class="content-block__text"><i>initial:</i><?php echo $textbody; ?></p>
    <p class="content-block__text"><i>result:</i></p>
</section>
